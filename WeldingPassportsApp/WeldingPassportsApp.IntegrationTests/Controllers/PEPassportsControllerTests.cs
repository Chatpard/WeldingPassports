...
namespace WeldingPassportsApp.IntegrationTests.Controllers
{
    ...
    public class PEPassportsControllerTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> _factory;

        public PEPassportsControllerTests(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }

        [Theory]
        [InlineData("/PEPassports/Index")]
        [InlineData("/PEPassports/Details", true)]
