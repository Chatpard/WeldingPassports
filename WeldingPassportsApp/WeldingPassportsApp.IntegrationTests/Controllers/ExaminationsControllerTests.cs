...
namespace WeldingPassportsApp.IntegrationTests.Controllers
{
    ...
    public class ExaminationsControllerTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> _factory;

        public ExaminationsControllerTests(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }

        [Theory]
        [InlineData("/Examinations/Index")]
        [InlineData("/Examinations/Details", true)]
