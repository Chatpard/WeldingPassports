...
{
    public class PostAdminAppSettingsEditRequest : IRequest<IActionResult>
    {
        public AppSettingsViewModel AppSettingsChanges { get; }
        public string NameOfDetailsAction { get; }
        public Controller Controller { get; }

        public PostAdminAppSettingsEditRequest(AppSettingsViewModel appSettingsChanges, string nameOfDetailsAction, Controller controller)
        {
