...
{
    public class PostAdminAppSettingsEditRequestHandler : IRequestHandler<PostAdminAppSettingsEditRequest, IActionResult>
    {
        private readonly IAppSettingsSQLRepository _repository;
        private readonly IMapper _mapper;

        public PostAdminAppSettingsEditRequestHandler(IAppSettingsSQLRepository repository, IMapper mapper)
        {
