...
{
    public class GetAdminApproveUserRequest : IRequest<IActionResult>
    {
        ...
        public GetAdminApproveUserRequest(string userToApproveEncryptedID, string role, string nameOfUsersToApproveIndexAction,
