...
namespace WeldingPassportsApp.IntegrationTests.Controllers
{
    ...
    public class ContactsControllerTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> _factory;

        public ContactsControllerTests(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        }
        ...
        [InlineData("/Contacts/Details", true)]
